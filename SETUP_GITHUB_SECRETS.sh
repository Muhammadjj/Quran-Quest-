...
echo ""
echo "    Add these lines to .gitignore if missing:"
...
if [ -f "android/app/upload-keystore.jks" ]; then
    ...
    if grep -Eq "upload-keystore\.jks|\*\.jks" .gitignore; then
...
echo ""
echo "If you do not have gh CLI installed, use GitHub website:"
echo "  https://github.com/Muhammadjj/Quran-Quest-/settings/secrets/actions"
echo ""
